...
define("API_KEY","5325067006:AAGofYHS8gdnHps9adjBbB__RjtsNhCOpVI");//توکن ربات خود را وارد کنید
flush();
...
Daie('sendMessage',[ 
    'chat_id'=>$chat_id, 
    'text'=>" 
سلام به ربات جنگ هیولاها خوش آمدید😉 
", 
'parse_mode'=>'Markdown', 
'reply_markup'=>json_encode([ 
'resize_keyboard'=>true,
...
",
            'reply_markup' => json_encode([
                  'inline_keyboard' => [
                    [
['text' => "ایجاد سرباز",'callback_data'=>"pack"]
                    ],[
['text' => "ایجاد هیولا",'callback_data'=>"pack"]
                        ]
                ]
            ])
]);
...
",
            'reply_markup' => json_encode([
                  'inline_keyboard' => [
                    [
['text' => "ایجاد",'callback_data'=>"pack"],[
    ['text' => "ایجاد هیولا",'callback_data'=>"pack2"]
    ]
                    ]
                ]
            ])
...
در صورت بروز هر گونه مشکل به آیدی زیر پیام دهید
@PoshtibaniMonsterWars
...
Daie('sendmessage',[ 
    'chat_id'=>$chat_id, 
    'text'=>" 
    دلت می خواد با رفاقت بازی کنی؟🛡️
یا دلت می خواد با دوستات کلن بزنی و با هاشون به کلن های دیگه اتک بزنید و با هم چت کنید؟🧐
دلت بازی های استراتژیک با سبک جدیدی می خواد اما تو تلگرام امکانش نیست؟😔
این شرایط در تلگرام فراهم شده تا بدون هیچ هزینه ای از بازی کنار دوستاتون لذت ببرید👑
در جنگ هیولا ها بجنگ و هیولا واقعی باش👾
